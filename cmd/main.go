...
func main() {
	...
	// registered (issue #13). An empty webhook server is a false sense of security.
	// Residual: ValidatingWebhookConfiguration + cert-manager + Helm :9443.
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "64157673.virtfoundry.io",
